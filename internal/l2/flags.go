...
var (
	stringFlags = []flagDef[string]{
		...
		{"sequencer-private-key", "l2.sequencer-private-key", "", "Sequencer private key (falls back to coordinator private key)"},
		...
		{"alt-da-challenge-proxy-address", "l2.alt-da.challenge-proxy-address", "", "Existing Alt-DA challenge proxy address to reuse on L1"},
		{"alt-da-challenge-impl-address", "l2.alt-da.challenge-impl-address", "", "Existing Alt-DA challenge implementation address to reuse on L1"},
	...
	boolFlags = []flagDef[bool]{
		...
		{"alt-da-skip-l1-deploy", "l2.alt-da.skip-l1-deploy", false, "Skip deploying Alt-DA L1 contracts and rely on pre-existing deployment state"},
		...
		{"op-succinct-release-build", "l2.op-succinct.release-build", false, "Build op-succinct with --release for optimized binaries (slower build)"},
	}
)
